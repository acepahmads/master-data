      ...
      <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-xs text-slate-300 max-w-2xl mt-1 leading-relaxed">
            Centralized platform governing Product Master (Trading, Project & R&D), central component library, parametric specifications, and multi-tier engineering lifecycles.
          </p>
        </div>
      ...
      <div class="lg:col-span-4 space-y-4">
        ...
        <div class="bg-gradient-to-br from-slate-900 via-navy-850 to-slate-900 rounded-xl p-4 text-white shadow-md border border-slate-800 space-y-2.5 relative overflow-hidden">
          ...
          <p class="text-2xs text-slate-300 leading-relaxed">
            All registered products (Trading, Project & R&D), components, suppliers, and change orders comply with enterprise PLM standards across Phases 1–6.
          </p>
