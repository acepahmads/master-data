...
export const projectPhases = [
  ...
  },
  {
    ...
    tagline: "Separates Trading, Project and Manufacture Product Behavior",
    status: "completed",
    badge: "COMPLETE",
    progress: 100,
    startDate: "2026-08-31",
    completedDate: "2026-08-31",
    description: "Separates Trading, Project and Manufacture product behavior. Establishes commercial sourcing terms for Trading products, turnkey solution trees for Project products, and multi-currency real-time exchange rates with product photo galleries.",
    modules: [
      { id: "M21", name: "3-Tier Product Type Taxonomy", code: "MOD-TYP", status: "completed", description: "Architectural classification into TRADING, PROJECT, and MANUFACTURE products." },
